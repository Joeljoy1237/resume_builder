  ...
  return (
    <>
      ...
      {mounted && resumes.length === 0 ? (
        ...
        <StaggerContainer
          stagger={100}
          className="mt-8 grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4"
        >
          {mounted &&
            resumes.map((resume) => {
              ...
              return (
                <div
                  ...
                  className={cn(
                    "group relative rounded-md border border-border bg-card p-5 transition-all duration-200 cursor-pointer hover:border-foreground/60 hover:bg-secondary/60 hover:shadow-sm hover:-translate-y-0.5",
